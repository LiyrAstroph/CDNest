...
levels_orig = np.loadtxt("levels3.txt", comments='#')
sample_info = np.loadtxt("sample_info3.txt", comments='#')
sample = np.atleast_2d(np.loadtxt("sample3.txt"))
